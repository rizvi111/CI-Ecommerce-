...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/site_style/stylesheet/stylesheet.css" type="text/css" media="screen" />
<link href='http://fonts.googleapis.com/css?family=Lobster' rel='stylesheet' type='text/css'/>
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/site_style/stylesheet/jquery-ui-1.8.9.custom.css" />
...
<script src="<?php echo base_url(); ?>assets/site_style/js/jquery.roundabout.min.js" type="text/javascript"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/site_style/js/jquery-ui-1.8.9.custom.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/site_style/js/tabs.js"></script>
<!-- Tipsy -->
...
<div id="container"> 
  ...
  <div id="sidefeatures">
    <ul>
        ...
        <div id="cart">
          ...
          <div class="content">
            <table class="cart">
              <tbody>
                <tr>
                  <td class="image"><a href="#"><img alt="Spicylicious" src="<?php echo base_url(); ?>assets/site_style/image/cart_pic1.jpg"/></a></td>
                  <td class="name"><a href="#">Product name 1</a>
                    <div> </div></td>
                  <td class="quantity">x&nbsp;1</td>
                  <td class="total">$117.50</td>
                  <td class="remove"><img title="Remove" alt="Remove" src="<?php echo base_url(); ?>assets/site_style/image/close.png"/></td>
                </tr>
                <tr>
                  <td class="image"><a href="#"><img title="Palm Treo Pro" alt="Palm Treo Pro" src="<?php echo base_url(); ?>assets/site_style/image/cart_pic2.jpg"/></a></td>
                ...
                <tr>
                  <td class="image"><a href="#"><img title="Canon EOS 5D" alt="Canon EOS 5D" src="<?php echo base_url(); ?>assets/site_style/image/cart_pic3.jpg"/></a></td>
      ...
      <li class="side_lang"><span class="icon">Language</span>
        <div id="language"> Language <a href="#" title="English"><img src="<?php echo base_url(); ?>assets/site_style/image/gb.png" alt="Spicylicious store"/></a> <a href="#" title="Deutsch"><img src="<?php echo base_url(); ?>assets/site_style/image/de.png" alt="Spicylicious store"/></a> <a title="Bylgarski"><img src="<?php echo base_url(); ?>assets/site_style/image/bg.png" alt="Spicylicious store"/></a> </div>
      </li>
  ...
  <div id="header">
    <div class="inner">
      ...
      <div id="logo"><a href="index.html"><img src="<?php echo base_url(); ?>assets/site_style/image/logo.png" width="217" height="141" alt="Spicylicious store" /></a></div>
      ...
      <div class="menu">
        ...
        <ul id="topnav">
          ...
          ?>
          <li><a href="<?php echo base_url() ?>Welcome/product_category/<?php echo $v_category->category_id; ?>"><?php echo $v_category->category_name; ?></a></li>
          <?php } ?>
        </ul>
      </div>
    </div>
          ...
          <div class="box-content">
            <ul id="myRoundabout">
              <?php
               ...
               ?>
              <li>
                <div class="prod_holder"> <a href="<?php echo base_url();?>Welcome/product_details/<?php echo $v_product->product_id?>"> <img src="<?php echo base_url().$v_product->product_image?>" width="300" height="300" alt="Spicylicious store" /> </a>
                  <h3><?php echo $v_product->product_name;?></h3>
                </div>
                <span class="pricetag"><?php echo $v_product->product_new_price;?></span> </li>
              <?php } ?>
            </ul>
  ...
  <div id="footer">
    <div class="inner">
      ...
      //]]>
          ...
          <script type="text/javascript" src="<?php echo base_url(); ?>assets/site_style/http://s7.addthis.com/js/250/addthis_widget.js#pubid=ra-4e7280075406aa87"></script> 
          <!-- AddThis Button END --> 
        </div>
      </div>
...
<!-- END OF MAIN WRAPPER --> 
<script type="text/javascript" src="<?php echo base_url(); ?>assets/site_style/http://twitter.com/javascripts/blogger.js"></script> 
<script type="text/javascript" src="<?php echo base_url(); ?>assets/site_style/http://twitter.com/statuses/user_timeline/d_koev.json?callback=twitterCallback2&amp;count=3"></script> 
